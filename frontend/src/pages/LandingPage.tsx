      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white   ">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-slate-900 ">HireMatch AI</span>
          </div>
          <nav className="hidden md:flex md:gap-x-8">
            <a className="text-sm font-semibold leading-6 text-slate-700 hover:text-primary " href="#">Features</a>
            <a className="text-sm font-semibold leading-6 text-slate-700 hover:text-primary " href="#">Pricing</a>
            <a className="text-sm font-semibold leading-6 text-slate-700 hover:text-primary " href="#">About</a>
          </nav>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="mx-auto max-w-4xl text-5xl font-black tracking-tight text-slate-900  sm:text-7xl">
                Know your match before <span className="text-primary">you apply</span>
              </h1>
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600 ">
                Paste a job description, upload your resume, and get your compatibility score in seconds. Stop guessing and start landing more interviews.
              </p>
            </div>
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
              <div className="flex flex-col space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-slate-500">{jdText.length} / 5000 characters</span>
                </div>
                <textarea 
              ...
              <div className="flex flex-col space-y-2">
                <label className="text-sm font-semibold text-slate-900 ">Your Resume</label>
                <div 
                ...
                >
                  ...
                  <div className="mt-2 text-sm leading-6 text-slate-600 ">
                    ...
                    {!file && <p>or <span className="text-primary hover:underline">click to upload</span></p>}
                  </div>
                  <p className="mt-2 text-xs text-slate-500">PDF, DOCX (Max 5MB)</p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-start gap-4 p-6 bg-white  rounded-2xl shadow-sm">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 ">Instant Match Score</h3>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 ">
                    Get a percentage score showing exactly how well your skills align with the role requirements.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-start gap-4 p-6 bg-white  rounded-2xl shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
                  <span className="material-symbols-outlined text-2xl font-bold">schema</span>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 ">Gap Analysis</h3>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 ">
                    Identify missing keywords and experience areas to optimize your resume before you hit submit.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-start gap-4 p-6 bg-white  rounded-2xl shadow-sm">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 ">
                    Receive personalized interview questions based on the specific job and your unique background.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold tracking-tight text-slate-900 ">HireMatch AI</span>
            </div>
